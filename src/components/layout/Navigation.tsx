      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="flex-shrink-0 min-w-0">
            <div className="font-serif text-lg sm:text-2xl font-bold text-ocean-trust">
              <div className="truncate">Exclusive Pro</div>
              <div className="text-xs sm:text-sm font-medium text-forest-calm -mt-1 truncate">
                Cleaning Services
              </div>
            </div>
          </div>
